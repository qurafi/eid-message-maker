...
function radialGradiant(ctx, x, y, c1, c2) {
  ...
  var r1 = width / 6,
      r2 = height * 0.75;
  var gradiant = ctx.createRadialGradient(x, y, Math.min(r1, r2), x, y, Math.max(width * 0.7, height * 0.7));
...
},{}],"../imgs/arpatt.svg":[function(require,module,exports) {
...
},{"./canvas":"js/canvas.js","./config":"js/config.js","./assets":"js/assets.js"}],"js/canvas.js":[function(require,module,exports) {
"use strict";
...
function draw(ctx, bg_aspect, ar) {
  ...
  var _aspect3 = aspect(width * 0.7, height * 0.6, 2160, 1080),
  ...
  ctx.fillText("كل عام وأنتم بخير", x1 + w / 2, height * 0.36 + logom);
  ctx.font = message_bold + " " + rfs(scheme[2] || temp == 2 ? 22 : 30, width) + "px " + font_message;
  var lines = (0, _utils.drawText)(ctx, _ui.ui.message_text.value, x1 + w / 2, height * 0.46 + (scheme[2] ? 0 : 15) + logom, w - (scheme[2] ? temp == 1 ? 200 : 150 : temp == 2 ? 150 : 0) - (message_bold ? 50 : 0));
...
},{"./utils":"js/utils.js","./config":"js/config.js","./ui":"js/ui.js"}],"../node_modules/regenerator-runtime/runtime.js":[function(require,module,exports) {
...
},{"regenerator-runtime/runtime":"../node_modules/regenerator-runtime/runtime.js","../style.css":"style.css","./ui":"js/ui.js","./assets":"js/assets.js","./canvas":"js/canvas.js","./utils":"js/utils.js"}],"js/main.js":[function(require,module,exports) {
"use strict";
...
require("./index");
},{"./utils":"js/utils.js","./config":"js/config.js","./assets":"js/assets.js","./canvas":"js/canvas.js","./ui":"js/ui.js","./index":"js/index.js"}],"../../../../../usr/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
